...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%-15s %-15d %-8d %d %n", policyPayout,
                policyPayout.unscaledValue(), policyPayout.scale(),
        ...
        System.out.printf("%-15s %-15d %-8d %d %n", checkAmount,
                checkAmount.unscaledValue(), checkAmount.scale(),
        ...
        System.out.printf("%-15s %-15d %-8d %d %n", totalChecksAmount,
                totalChecksAmount.unscaledValue(), totalChecksAmount.scale(),
