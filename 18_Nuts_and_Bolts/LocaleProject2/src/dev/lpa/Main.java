...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        out.print("Enter the loan amount: ");
        ...
        out.println("My Loan " + decimalInfo.format(myLoan));
    }
}