...
public class PartitionPrimeNumbers {
    ...
    public static void main(final String... args) {
        out.println("\nNumbers partitioned in prime and non-prime: " + partitionPrimes(100));
    ...
    public static Map<Boolean, List<Integer>> partitionPrimesWithCustomCollector(final int n) {
        return IntStream
            .rangeClosed(2, n)
            .boxed()
    ...
    private static boolean isPrime(final List<Integer> primes, final Integer candidate) {
    ...
    public static class PrimeNumbersCollector implements
        ...
        public BiConsumer<Map<Boolean, List<Integer>>, Integer> accumulator() {
            return (final Map<Boolean, List<Integer>> acc, final Integer candidate) ->
        ...
        public BinaryOperator<Map<Boolean, List<Integer>>> combiner() {
            return (final Map<Boolean, List<Integer>> map1, final Map<Boolean, List<Integer>> map2) -> {
    ...
    public Map<Boolean, List<Integer>> partitionPrimesWithInlineCollector(final int n) {
        System.out.println("\n++++++++++++++++++++++++++++++++++++++++++++++++\n");
